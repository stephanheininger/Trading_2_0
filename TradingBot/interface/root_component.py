            ...
            try:
                for b_index, strat in client.strategies.items():
                    ...
                    for trade in strat.trades:
                        if trade.time not in self.trades_frame.body_widgets['symbol']:
                            self.trades_frame.add_trade(trade)
                        ...
                        self.trades_frame.body_widgets['pnl_var'][trade.time].set(pnl_str)
                        self.trades_frame.body_widgets['status_var'][trade.time].set(trade.status.capitalize())
